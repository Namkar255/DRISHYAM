 ...
 */
import { AlertTriangle, ArrowUpRight, Check, FileText, Network, Search, ShieldCheck, Upload } from "lucide-react";
...
// What each card says has to be what the product does. The extraction card in particular still
// described phones, UPI IDs and URLs -- the cyber-fraud vocabulary this started as -- while
// SIH26189 asks for people, vehicles, places and organisations, which is what the pipeline now
// reads. A capability list that lags the code is the first thing a judge checks and finds.
const capabilities = [
  { number: "01", label: "SOURCE INTAKE", title: "Collect evidence", description: "The original is stored untouched and hashed on arrival. Every later step reads a copy of it.", Icon: Upload, asset: toolkitAssets.upload, visual: "upload" },
  { number: "02", label: "ENTITY EXTRACTION", title: "Read what is there", description: "People, vehicles, places and organisations — each kept with the page, row or image region it was read from.", Icon: Search, asset: toolkitAssets.extract, visual: "extract" },
  { number: "03", label: "RELATIONSHIP GRAPH", title: "Build connections", description: "Called, transferred to, used vehicle, located at. Every edge carries the record that states it.", Icon: Network, asset: toolkitAssets.graph, visual: "graph" },
  { number: "04", label: "INVESTIGATION SIGNAL", title: "Detect & alert", description: "Fourteen rules, from relay contact to one handset on two numbers. Each alert shows the facts behind it.", Icon: AlertTriangle, asset: toolkitAssets.alert, visual: "alert" },
  { number: "05", label: "CASE RECORD", title: "Generate reports", description: "Four documents for four readers, with findings numbered F-01 upward that open at their source row.", Icon: FileText, asset: toolkitAssets.report, visual: "report" },
  { number: "06", label: "EVIDENCE INTEGRITY", title: "Prove it holds", description: "An audit chain recomputed on demand, and a root fixing which files a report covered.", Icon: ShieldCheck, asset: toolkitAssets.secure, visual: "secure" },
];
